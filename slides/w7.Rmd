...
**Gephi** is an open-source network analysis and visualization software package based on Java. <http://gephi.org>
...
-   Installation and installation issues (Java version, Gephi version etc.)
